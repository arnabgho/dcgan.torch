...
parser.add_argument('--outf', default='./up_resnet_gen', help='folder to output images and model checkpoints')
...
class _netG(nn.Module):
    def __init__(self,ngpu):
        ...
        #main_block += [nn.ReLU(True)]
        # state size. (ngf*4) x 8 x 8
        main_block += [upDeconvResBlock(ngf*8,ngf*4,dropout=opt.dropout)] #[upDeconvBATCHResBlock(ngf*8,ngf*4,dropout=opt.dropout)]
        tch=ngf*4
        #main_block += [BATCHResBlock(tch, tch)]
        #main_block += [BATCHResBlock(tch, tch)]
        #main_block += [BATCHResBlock(tch, tch)]
        ...
        #main_block += [nn.ReLU(True)]
        main_block += [upDeconvResBlock(ngf*4,ngf*2,dropout=opt.dropout)] #[upDeconvBATCHResBlock(ngf*4,ngf*2,dropout=opt.dropout)]
        # state size. (ngf*2) x 16 x 16
        ...
        #main_block += [nn.ReLU(True)]
        main_block += [upDeconvResBlock(ngf*2,ngf,dropout=opt.dropout)]
        #[upDeconvBATCHResBlock(ngf*2,ngf,dropout=opt.dropout)]
        # state size. (ngf) x 32 x 32
        ...
        main_block += [upDeconvResBlock(ngf,nc,dropout=opt.dropout)]
        #[upDeconvResBlock(ngf*2,ngf,dropout=opt.dropout)]
...
class _netD(nn.Module):
    def __init__(self,ngpu):
        ...
        #main_block += [nn.Dropout(opt.dropout)]
        main_block += [downConvResBlock(nc,ndf,dropout=opt.dropout)]
        #[downConvBATCHResBlock(nc,ndf,dropout=opt.dropout)]
        tch=ndf
        #main_block += [BATCHResBlock(tch, tch)]
        ...
        main_block += [downConvResBlock(ndf,ndf*2,dropout=opt.dropout)]
        #[downConvBATCHResBlock(ndf,ndf*2,dropout=opt.dropout)]
        tch=ndf*2
        ...
        main_block += [downConvResBlock(ndf*2,ndf*4,dropout=opt.dropout)]
        #[downConvBATCHResBlock(ndf*2,ndf*4,dropout=opt.dropout)]
        tch=ndf*4
        #main_block += [BATCHResBlock(tch, tch)]
        #main_block += [BATCHResBlock(tch, tch)]
        #main_block += [BATCHResBlock(tch, tch)]
        ...
        main_block += [downConvResBlock(ndf*4,ndf*8,dropout=opt.dropout)]
        #[downConvBATCHResBlock(ndf*4,ndf*8,dropout=opt.dropout)]
        tch=ndf*8
        #main_block += [ResBlock(tch, tch,dropout=opt.dropout)]
        #main_block += [ResBlock(tch, tch,dropout=opt.dropout)]
        #main_block += [ResBlock(tch, tch,dropout=opt.dropout)]
