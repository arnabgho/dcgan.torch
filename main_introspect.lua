...
netG1:add(SpatialFullConvolution(nz, ngf * 8, 4, 4))
netG1:add(SpatialBatchNormalization(ngf * 8)):add(nn.ReLU(true))
-- state size: (ngf*8) x 4 x 4
netG1:add(SpatialFullConvolution(ngf * 8, ngf * 4, 4, 4, 2, 2, 1, 1))
netG1:add(SpatialBatchNormalization(ngf * 4)):add(nn.ReLU(true))
-- state size: (ngf*4) x 8 x 8
netG1:add(SpatialFullConvolution(ngf * 4, ngf * 2, 4, 4, 2, 2, 1, 1))
netG1:add(SpatialBatchNormalization(ngf * 2)):add(nn.ReLU(true))
-- state size: (ngf*2) x 16 x 16
netG1:add(SpatialFullConvolution(ngf * 2, ngf, 4, 4, 2, 2, 1, 1))
netG1:add(SpatialBatchNormalization(ngf)):add(nn.ReLU(true))
-- state size: (ngf) x 32 x 32
netG1:add(SpatialFullConvolution(ngf, nc, 4, 4, 2, 2, 1, 1))
netG1:add(nn.Tanh())
...
-- input is Z, going into a convolution
netG2:add(SpatialFullConvolution(nz, ngf * 8, 4, 4))
netG2:add(SpatialBatchNormalization(ngf * 8)):add(nn.ReLU(true))
-- state size: (ngf*8) x 4 x 4
netG2:add(SpatialFullConvolution(ngf * 8, ngf * 4, 4, 4, 2, 2, 1, 1))
netG2:add(SpatialBatchNormalization(ngf * 4)):add(nn.ReLU(true))
-- state size: (ngf*4) x 8 x 8
netG2:add(SpatialFullConvolution(ngf * 4, ngf * 2, 4, 4, 2, 2, 1, 1))
netG2:add(SpatialBatchNormalization(ngf * 2)):add(nn.ReLU(true))
-- state size: (ngf*2) x 16 x 16
netG2:add(SpatialFullConvolution(ngf * 2, ngf, 4, 4, 2, 2, 1, 1))
netG2:add(SpatialBatchNormalization(ngf)):add(nn.ReLU(true))
-- state size: (ngf) x 32 x 32
netG2:add(SpatialFullConvolution(ngf, nc, 4, 4, 2, 2, 1, 1))
netG2:add(nn.Tanh())
-- state size: (nc) x 64 x 64

netG2:apply(weights_init)

local netI = nn.Sequential()

-- input is (nc) x 64 x 64
netI:add(SpatialConvolution(nc, ndf, 4, 4, 2, 2, 1, 1))
netI:add(nn.LeakyReLU(0.2, true))
-- state size: (ndf) x 32 x 32
netI:add(SpatialConvolution(ndf, ndf * 2, 4, 4, 2, 2, 1, 1))
netI:add(SpatialBatchNormalization(ndf * 2)):add(nn.LeakyReLU(0.2, true))
-- state size: (ndf*2) x 16 x 16
netI:add(SpatialConvolution(ndf * 2, ndf * 4, 4, 4, 2, 2, 1, 1))
netI:add(SpatialBatchNormalization(ndf * 4)):add(nn.LeakyReLU(0.2, true))
-- state size: (ndf*4) x 8 x 8
netI:add(SpatialConvolution(ndf * 4, ndf * 8, 4, 4, 2, 2, 1, 1))
netI:add(SpatialBatchNormalization(ndf * 8)):add(nn.LeakyReLU(0.2, true))
-- state size: (ndf*8) x 4 x 4
netI:add(SpatialConvolution(ndf * 8, 1, 4, 4))
netI:add(nn.Sigmoid())
-- state size: 1 x 1 x 1
netI:add(nn.View(1):setNumInputDims(3))
-- state size: 1

netI:apply(weights_init)

netI_clone=netI:clone('weight','bias','gradWeight','gradBias')
...
local parametersI, gradParametersI = netI:getParameters()
local parametersI_clone, gradParametersI_clone=netI_clone:getParameters()
