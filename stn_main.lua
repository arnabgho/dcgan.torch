...
local locnet = nn.Sequential()
-- input 3x64x64
locnet:add(nn.SpatialConvolution(3,40,4,4,2,2,1,1))
-- input 5x32x32
locnet:add(nn.SpatialBatchNormalization(40)):add(nn.LeakyReLU(0.2, true))
locnet:add(nn.SpatialConvolution(40,40,4,4,2,2,1,1))
-- input 5x16x16
locnet:add(nn.SpatialBatchNormalization(40)):add(nn.LeakyReLU(0.2, true))
locnet:add(nn.SpatialConvolution(40,40,4,4,2,2,1,1))
-- input 5x8x8
locnet:add(nn.SpatialBatchNormalization(40)):add(nn.LeakyReLU(0.2, true))
locnet:add(nn.SpatialConvolution(40,5,4,4,2,2,1,1))
locnet:add(nn.SpatialBatchNormalization(5)):add(nn.LeakyReLU(0.2, true))
locnet:add(nn.View(20*2*2))
locnet:add(nn.Linear(20*2*2,20))
...
-- Adding the Spatial Transformer Network To the Generator
netG:add(spanet)

netG:apply(weights_init)

local netD = nn.Sequential()
-- Adding the Spatial Transformer Network Module to the Discriminator as well
--netD:add(spanet)
