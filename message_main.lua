...
for epoch = 1, opt.niter do
   ...
   torch.save('checkpoints_message/' .. opt.name .. '_' .. epoch .. '_net_G.t7', {G.netG1:clearState(),G.netG2:clearState(),G.netI:clearState() } )
   torch.save('checkpoints_message/' .. opt.name .. '_' .. epoch .. '_net_D.t7', netD:clearState())
